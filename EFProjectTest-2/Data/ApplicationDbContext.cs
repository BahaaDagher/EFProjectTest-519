...
using EFProjectTest_2.Models;
using Microsoft.EntityFrameworkCore;

namespace EFProjectTest_2.Data;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E27BBE945B7");
        });

        modelBuilder.Entity<Category>(entity =>
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B49DD1E72F");
        });

        modelBuilder.Entity<Customer>(entity =>
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB858828E4B9");
        });

        modelBuilder.Entity<Log>(entity =>
        {
            entity.HasKey(e => e.LogId).HasName("PK__logs__9E2397E059FDD796");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__465962297B75103B");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D42166D57E");
        ...
        {
            entity.HasKey(e => e.PartId).HasName("PK__parts__A0E3FAB8D73F5FE9");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF55A05F9A2");
        ...
        {
            entity.HasKey(e => e.ChangeId).HasName("PK__product___F4EFE596FE803862");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9CEFC57F9E");
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D38D78946F");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30CFE3721FB");
        });
